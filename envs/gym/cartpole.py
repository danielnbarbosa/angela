...
def dqn(render, load_file):
    model = models.dqn.Dueling2x(state_size=4, action_size=2, fc_units=(64, 32), seed=SEED)
...
def hc(render, load_file):
    model = models.hc.SingleLayerPerceptron(state_size=4, action_size=2, seed=SEED)
